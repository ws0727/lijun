...
{
    /**
     * caching node to create nocache code but no cache file
     */
    ...
    public function compile($args, Smarty_Internal_SmartyTemplateCompiler $compiler)
    {
        ...
        // caching was on and {include} is not in nocache node
        ...
        */
        ...
        // if subtemplate will be called in nocache node do not merge
